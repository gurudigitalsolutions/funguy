...
namespace FunGuy
{
    ...
    class Game : GameWindow
    {
        ...
        /// </value>
        public bool ModeIsGame { get { return (GameMode == GameModeGame); } }
        /// <summary>
        ...
        /// </value>
        public bool ModeIsEditor { get { return (GameMode == GameModeEditor); } }
        /// <summary>
        ...
        /// </value>
        public bool ModeIsThings { get { return (GameMode == GameModeThings); } }
        /// <summary>
        ...
        /// </value>
        public bool ModeIsThingsEditor { get { return (GameMode == GameModeThingEditor); } }
        ...
        protected void OnKeyPress()
        {
            ...
            if (ThePlayer.CanMove())
            {
                ...
                if (Keyboard [Key.Down])
                {
                    ...
                    CharDirection = MyCharacter.Down;
                    //
                    if (ThePlayer.PosY > 0 && (!ModeIsThings)
                        && (ModeIsEditor || (TheMap.Coordinates [ThePlayer.PosX, ThePlayer.PosY - 1] > -1) && !TheMap.IsThingAt(ThePlayer.PosX, ThePlayer.PosY - 1)))
                    {
                        ThePlayer.PosY--;
                    }
                ...
                {
                    // Character direction
                    CharDirection = MyCharacter.Left;
                    //
                    if (ThePlayer.PosX > 0
                        && (GameMode != GameModeThings)
                ...
                {
                    // Character direction
                    CharDirection = MyCharacter.Right;
                    //
                ...
                if ((Keyboard [Key.Period] || Keyboard [Key.Comma]))
                {
                    ...
                    if (GameMode == GameModeEditor)
                    {
                        next = TheMap.Textures.Find(
                            t => t.Value == TheMap.Coordinates [ThePlayer.PosX, ThePlayer.PosY]).Index;
                        ...
                        else if (TheMap.Textures.Count < next){
                            next = 1;}

                        TheMap.Coordinates [ThePlayer.PosX, ThePlayer.PosY] = 
                            TheMap.Textures.Find(n => n.Index == next).Value;
                    }
                    else if (GameMode == GameModeThings)
                    {
                        next = ThingIndex;
